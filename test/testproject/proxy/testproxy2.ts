...
namespace MovieService {
	...
	export class MovieContainer extends odatatools.ProxyBase {
		...
		Movies: MoviesEntitySet;
		Customers: CustomersEntitySet;
		Addresses: AddressesEntitySet;
	...
	//EntitySets
	export class MoviesEntitySet extends odatatools.EntitySet<ODataTestService.Models.Movie> {
		constructor(name: string, address: string, key: string, additionalHeaders?: odatajs.Header) {
	...
	export class CustomersEntitySet extends odatatools.EntitySet<ODataTestService.Models.Customer> {
		constructor(name: string, address: string, key: string, additionalHeaders?: odatajs.Header) {
			super(name, address, key, additionalHeaders);
		}
	...
	export class AddressesEntitySet extends odatatools.EntitySet<ODataTestService.Models.Address> {
		constructor(name: string, address: string, key: string, additionalHeaders?: odatajs.Header) {
			super(name, address, key, additionalHeaders);
		}
