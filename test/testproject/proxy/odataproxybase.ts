...
export abstract class ODataQueryFilterOptions<T> extends ODataQueryOptionBase {
...
export abstract class ODataQueryOptionsGetSingle<T> extends ODataQueryFilterOptions<T> {
    abstract Get(): Promise<T[]>;
 ...
 * @template T
 */
export class EntitySet<T> extends ODataQueryOptionsGetSingle<T> {
...
export declare namespace odatajs {
    class oData {
