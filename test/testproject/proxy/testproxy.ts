...
namespace Microsoft.OData.Service.Sample.TrippinInMemory.Models {
  ...
  export interface Event
    extends Microsoft.OData.Service.Sample.TrippinInMemory.Models.PlanItem {
  ...
  export interface Flight
    extends Microsoft.OData.Service.Sample.TrippinInMemory.Models
  ...
  export interface Employee
    extends Microsoft.OData.Service.Sample.TrippinInMemory.Models.Person {
    Cost: Edm.Int64;
  ...
  export class Container extends odatatools.ProxyBase {
    constructor(
      ...
      this.People = new PeopleEntitySet(
        "People",
        address,
        "UserName",
        additionalHeaders
      );
      this.Airlines = new AirlinesEntitySet(
        "Airlines",
        address,
        "AirlineCode",
        additionalHeaders
      );
      this.Airports = new AirportsEntitySet(
        "Airports",
        address,
        "Name",
        additionalHeaders
      );
      this.NewComePeople = new NewComePeopleEntitySet(
        "NewComePeople",
        address,
        "UserName",
        additionalHeaders
    ...
    GetPersonWithMostFriends(): Promise<
    ...
    GetNearestAirport(
      lat: Edm.Double,
      lon: Edm.Double
    ): Promise<Microsoft.OData.Service.Sample.TrippinInMemory.Models.Airport> {
      return new Promise<
      ...
      >((resolve, reject) => {
        let request: odatajs.Request = {
          ...
          method: "GET",
          requestUri:
            this.Address + "/GetNearestAirport(lat=" + lat + ",lon=" + lon + ")"
        };
        odatajs.oData.request(
          request,
          (data, response) => {
  ...
  //EntitySets
  export class PeopleEntitySet extends odatatools.EntitySet<
    Microsoft.OData.Service.Sample.TrippinInMemory.Models.Person
  > {
    constructor(
      name: string,
    ...
    GetFavoriteAirline(
      person: Microsoft.OData.Service.Sample.TrippinInMemory.Models.Person
    ): Promise<Microsoft.OData.Service.Sample.TrippinInMemory.Models.Airline> {
      return new Promise<
    ...
    GetFriendsTrips(
      person: Microsoft.OData.Service.Sample.TrippinInMemory.Models.Person,
      userName: Edm.String
    ): Promise<Microsoft.OData.Service.Sample.TrippinInMemory.Models.Trip> {
      return new Promise<
  ...
  export class AirlinesEntitySet extends odatatools.EntitySet<
    Microsoft.OData.Service.Sample.TrippinInMemory.Models.Airline
  > {
    constructor(
      name: string,
  ...
  export class AirportsEntitySet extends odatatools.EntitySet<
    Microsoft.OData.Service.Sample.TrippinInMemory.Models.Airport
  > {
    constructor(
      name: string,
  ...
  export class NewComePeopleEntitySet extends odatatools.EntitySet<
    Microsoft.OData.Service.Sample.TrippinInMemory.Models.Person
  > {
    constructor(
      name: string,
